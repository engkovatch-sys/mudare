          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-[#C87533]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href={`https://wa.me/551151961909`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#C87533] transition-colors text-sm">
